...
class RP_Indi_Event_Mysql_Dao extends Rp_Mysql_DAO {
	 ...
	 * @return
	 */
	public function load_list( $indi_id, $indi_batch_id, $dummy1 = 0, $dummy2 = 0, $dummy3 = 0 ) {
	 ...
	 * @return
	 */
	public function delete_by_indi_id( $indi_id, $indi_batch_id, $dummy1 = 0, $dummy2 = 0, $dummy3 = 0 ) {
	 ...
	 */
	public function load( $indi_id, $indi_batch_id, $event_id, $dummy1 = 0, $dummy2 = 0 ) {
	 ...
	 */
	public function delete( $indi_id, $indi_batch_id, $event_id, $dummy1 = 0, $dummy2 = 0 ) {
