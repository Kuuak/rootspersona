...
class RP_Indi_Cite_Mysql_Dao extends Rp_Mysql_DAO {
	 ...
	 */
	public function load( $indi_id, $indi_batch_id, $cite_id, $dummy1 = 0, $dummy2 = 0 ) {
	 ...
	 */
	public function delete( $indi_id, $indi_batch_id, $cite_id, $dummy1 = 0, $dummy2 = 0 ) {
